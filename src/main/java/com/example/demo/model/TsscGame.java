...
public class TsscGame implements Serializable {
	...
	private long id;
	@NotBlank(message = "Este campo no puede estar vac�o", groups=GameValidated.class)
	@Column(name = "ADMIN_PASSWORD")
	private String adminPassword;
	@NotBlank(message = "Este campo no puede estar vac�o", groups=GameValidated.class)
	@Column(name = "GUEST_PASSWORD")
	private String guestPassword;
	@Min(value = 1, message = "El n�mero de grupos debe ser mayor a 0", groups=GameValidated.class)
	@Column(name = "N_GROUPS")
	private Integer nGroups = 4;
	@Min(value = 1, message = "El n�mero de sprints debe ser mayor a 0", groups=GameValidated.class)
	@Column(name = "N_SPRINTS")
	private Integer nSprints = 4;
	@NotBlank(message = "El nombre est� vac�o", groups=GameValidated.class)
	private String name;
	...
	@NotBlank(message = "Debes ingresar una contrase�a", groups=GameValidated.class)
